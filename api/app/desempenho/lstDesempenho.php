                          ...
                          P_CODETAPA=>12)
                               ...
                               WHERE
                                 ...
                                 (
                                   ...
                                   STURMADISC.CODTURMA NOT LIKE 'EC%' AND
                                   SMATRICULA.IDTURMADISCORIGEM IS NULL                                   
                                   and  STURMADISC.CODTURMA = (SELECT X.CODTURMA FROM RM.VW_ALUNOS_MATRICULADOS X WHERE X.RA = :CD_ALUNO)
                                   /*(SELECT RESP.TURMA FROM RM.VW_ALUNO_RESP_RM_GERAL RESP WHERE RA = :CD_ALUNO)*/
