...
$numeroEstabelecimento_Producao       = "1051047860";
$chaveCielo_Produto         = "dd8b9b4c3fa1ed6594afff1fa2d4473924153eb01a04e4f9f3c873fe44245512";


$numeroEstabelecimento_Homologacao    = "1006993069";
$chaveCielo_Homologacao     = "25fbb99741c739dd84d7b06ec78c9bac718838630f30b112d033ce2e621b34f3";
...
<dados-ec>
      <numero>'.$numeroEstabelecimento_Homologacao.'</numero>
      <chave>'.$chaveCielo_Homologacao.'</chave>
</dados-ec>
<dados-portador>
...
<forma-pagamento>
    ...
    <produto>'.$p_form_pagamento.'</produto>
...
if ($xml->tid){
    $tid_msg = 'TID da transação: '.$xml->tid;
